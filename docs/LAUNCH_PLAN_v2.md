...
│ Game ID: xxx-xxx-xxx          [Copy]       │
├────────────────────────────────────────────┤
│ ⚓ Blockchain Anchor                       │
│ Block Height: #1,234,567      [Explorer →] │
│ Block Hash: abc123...def456   [Full][Copy] │
│ TX Hash: xyz789...            [Full][Copy] │
│ TX Index: 3 of 47                          │
│ Timestamp: Jan 20, 2026 3:45 PM            │
├────────────────────────────────────────────┤
│ 🔐 Seed Formula / anti-spoofing (collapsible)│
│ seed = SHA256(blockHash + txHash + ...)    │
├────────────────────────────────────────────┤
│ ✅ VERIFIED                                │
│ [Game-specific data replay/history]        │
├────────────────────────────────────────────┤
